...
- **RESULT (post-tag):** ✅ **H1 SUPPORTED** — pilot (load-under-contention) decode 0.52×, spill 0.97 GB, ×2 reproducible; **resident-server (I-3) decode 0.19× (5× slower) evicting a *hot* model**, with a hog sweep showing a sharp demotion cliff at the VRAM-budget crossover. See [`../results/H1-eviction-pilot-20260619.md`](../results/H1-eviction-pilot-20260619.md) + [`../results/H1-resident-sweep-20260619.md`](../results/H1-resident-sweep-20260619.md). *(Prediction below unchanged — this records the outcome.)*
